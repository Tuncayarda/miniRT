...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/14 18:24:58 by tuaydin           #+#    #+#             */
/*   Updated: 2025/11/14 18:46:56 by tuaydin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	compute_one(t_scene *sc, t_trace_var *var, t_ray r)
{
	...
	if (var->spc.nl > 0)
	{
		var->spc.spc_term = powf(fmax(0,
					vec_dot(var->spc.r, var->spc.v)),
				var->mat.shininess);
		var->spc.spc_int = var->mat.specular_strength
			* var->spc.spc_term * sc->lights[var->li].ratio;
